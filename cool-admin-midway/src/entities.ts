// 自动生成的文件，请勿手动修改
import * as entity0 from './modules/user/entity/withdraw';
import * as entity1 from './modules/user/entity/walletLog';
import * as entity2 from './modules/user/entity/transaction';
import * as entity3 from './modules/user/entity/recharge';
